...
1. In the new session picker, choose **挖洞模式** for bounty-oriented work or **红队模式** for a staged authorized assessment.
...
The Web **挖洞** or **红队** tab (per-session) shows the same durable graph live: chain / findings / assets / report.
